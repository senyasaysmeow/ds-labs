"""
Задача:
   Підприємство планує розгорнути корпоративну ERP-систему
   та має бюджет на закупівлю двох типів серверів:

     x₁ — сервери застосунків
...
# =============================================================================
# 2. Розв'язок методом Google OR-Tools (GLOP)
# =============================================================================
...
def print_problem_statement() -> None:
    ...
    print("    x₁ — кількість серверів застосунків")
    print(
        "         Вартість: 600 тис. грн  |  Споживання: 1 кВт  |  Продуктивність: 5 ум.од."
    )
    print("    x₂ — кількість серверів баз даних")
    print(
        "         Вартість: 400 тис. грн  |  Споживання: 2 кВт  |  Продуктивність: 4 ум.од."
    )
    print()
